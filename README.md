...
- **Текст песни** с подсветкой строки там, где сервис отдаёт метки времени.
...
Метки времени отдаёт Яндекс; у VK их нет, и там честно показывается просто
текст, без подсветки, которая бы ничего не значила.
