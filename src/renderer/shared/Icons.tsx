...
/*
 * Шестерёнка нарисована кольцами: внешний обод с вырезом и сердцевина с
 * дыркой. Обычное правило заливки дырки не оставляет — обе окружности
 * закрашиваются, и от значка остаётся клякса. `evenodd` вырезает то, что
 * обведено дважды, ради чего кольца и рисуют.
 */
export const Gear = ({ size = 14 }: Props) => (
  <svg {...base(size)} fillRule="evenodd">
...
/** Волна: расходящиеся дуги, как у радиосигнала. */
export const Radio = ({ size = 14 }: Props) => (
  <svg {...base(size)}>
    <path d="M12 10.4a1.6 1.6 0 1 1 0 3.2 1.6 1.6 0 0 1 0-3.2Z" />
    <path d="M8.2 8.2a5.4 5.4 0 0 0 0 7.6l1.4-1.4a3.4 3.4 0 0 1 0-4.8zm7.6 0-1.4 1.4a3.4 3.4 0 0 1 0 4.8l1.4 1.4a5.4 5.4 0 0 0 0-7.6Z" />
    <path d="M5.4 5.4a9.4 9.4 0 0 0 0 13.2l1.4-1.4a7.4 7.4 0 0 1 0-10.4zm13.2 0-1.4 1.4a7.4 7.4 0 0 1 0 10.4l1.4 1.4a9.4 9.4 0 0 0 0-13.2Z" />
  </svg>
)
